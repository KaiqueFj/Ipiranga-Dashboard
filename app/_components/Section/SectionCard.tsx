...
export default function SectionCard({ section }: Props) {
  ...
  return (
    <div
      className={`flex flex-col h-full rounded-2xl border px-4 py-2 shadow-xl bg-slate-900/40 backdrop-blur-sm border-l-4 ${borderColor} border-slate-800  overflow-hidden`}
    >
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 xl:grid-cols-4 gap-4 md:gap-6 p-4">
